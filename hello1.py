# Copyright 2020 sky。模块注释

"""Hello world for learning。文档注释"""
...
"""这是单行文档注释，可以被pydoc工具从源代码中提取这些信息，生成html文件"""
"""这是多行文档注释，第一行后如果还有注释内容，应该加一个空行
...
print('**演示变量-start**')
string = "hello world"
print("本地string变量:" + string)
string = 1
print("python是动态类型语言。不检查变量类型，可以改变变量类型。str改为整数：", string)
